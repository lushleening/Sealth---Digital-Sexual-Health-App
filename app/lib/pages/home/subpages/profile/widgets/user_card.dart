...
import 'package:sddp_dsh/pages/home/subpages/profile/widgets/login_choice_popup.dart';
...
class UserCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AsyncPage(
      state: state,
      pageContent: (up) => up.user.isRegistered
          ? RegisteredUserCard(profile: up.profile!)
          : const GuestUserCard(),
      logTextOnError: (_, _) => "FAILURE",
    );
  }
}
...
class RegisteredUserCard extends StatelessWidget {
  final RegisteredProfile profile;
