...
@JsonKey(name: "uuid") String get uuid;@JsonKey(name: "title") String get title;@JsonKey(name: "description") String get description;// Use NotificationType.*.name instead of normal Strings for accurate results
