...
@JsonKey(name: "id") int? get id;@JsonKey(name: "title") String get title;@JsonKey(name: "description") String get description;// Use NotificationType.*.name instead of normal Strings for accurate results
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,notificationType,isAlertMessage,hasRead,linkToPage,scheduledAt,updatedAt);

@override
String toString() {
  return 'AppNotifications(id: $id, title: $title, description: $description, notificationType: $notificationType, isAlertMessage: $isAlertMessage, hasRead: $hasRead, linkToPage: $linkToPage, scheduledAt: $scheduledAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of AppNotifications
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = null,Object? description = null,Object? notificationType = null,Object? isAlertMessage = null,Object? hasRead = null,Object? linkToPage = null,Object? scheduledAt = null,Object? updatedAt = null,}) {
...
switch (_that) {
case _AppNotifications() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.notificationType,_that.isAlertMessage,_that.hasRead,_that.linkToPage,_that.scheduledAt,_that.updatedAt);case _:
  return orElse();
...
/// Create a copy of AppNotifications
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? title = null,Object? description = null,Object? notificationType = null,Object? isAlertMessage = null,Object? hasRead = null,Object? linkToPage = null,Object? scheduledAt = null,Object? updatedAt = null,}) {
