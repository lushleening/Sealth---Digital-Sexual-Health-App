...
mixin _$AppMetadata {
 ...
 String get appName; String get version; String get buildNumber;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppMetadata&&(identical(other.appName, appName) || other.appName == appName)&&(identical(other.version, version) || other.version == version)&&(identical(other.buildNumber, buildNumber) || other.buildNumber == buildNumber));
}


@override
int get hashCode => Object.hash(runtimeType,appName,version,buildNumber);

@override
String toString() {
  return 'AppMetadata(appName: $appName, version: $version, buildNumber: $buildNumber)';
}
...
@useResult
$Res call({
 String appName, String version, String buildNumber
});
...
/// Create a copy of AppMetadata
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? appName = null,Object? version = null,Object? buildNumber = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String appName,  String version,  String buildNumber)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppMetadata() when $default != null:
return $default(_that.appName,_that.version,_that.buildNumber);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String appName,  String version,  String buildNumber)  $default,) {final _that = this;
switch (_that) {
case _AppMetadata():
return $default(_that.appName,_that.version,_that.buildNumber);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String appName,  String version,  String buildNumber)?  $default,) {final _that = this;
switch (_that) {
case _AppMetadata() when $default != null:
return $default(_that.appName,_that.version,_that.buildNumber);case _:
  return null;
...
class _AppMetadata extends AppMetadata {
  const _AppMetadata({required this.appName, required this.version, required this.buildNumber}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppMetadata&&(identical(other.appName, appName) || other.appName == appName)&&(identical(other.version, version) || other.version == version)&&(identical(other.buildNumber, buildNumber) || other.buildNumber == buildNumber));
}
...
/// Create a copy of AppMetadata
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? appName = null,Object? version = null,Object? buildNumber = null,}) {
