...
class NearbyService {
  ...
  // Build from Supabase clinics row
    ...
    return Column(
      children: [
        ...
        if (filtered.isEmpty)
          ...
          ...filtered.map((service) => _ServiceCard(service: service, ref: ref)),
      ],
    );
  }
}
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                // Navigate to AddEventPage with clinicId pre-filled
                navPush(
                  context,
                  ref,
                  AddEventPage(preselectedClinicId: service.clinicId),
                );
              },
